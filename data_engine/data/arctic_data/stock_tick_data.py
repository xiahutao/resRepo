...
from data_engine.setting import FREQ_TICK,STOCK_TICK_LIB
from arctic.exceptions import NoDataFoundException

_logger = logging.getLogger(__name__)

class StockTickData(StockData):
    '''
        分钟数据接口，从Artic加载
    '''
    def __init__(self,price_type=Setting.PRICE_TYPE_UN,**kwargs):
        StockData.__init__(self,freq=FREQ_TICK,price_type=price_type,**kwargs)

    def _get_arclib_str(self):
        return STOCK_TICK_LIB
